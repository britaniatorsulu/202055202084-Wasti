...
include"koneksi.php";
$id= $_GET['id'];
$data= mysqli_query($koneksi,"SELECT * FROM 202055202084_ where nim='$id'");
...
if(isset($_POST['simpan'])){
	...
	$sql  = "UPDATE 202055202084_ SET nim='$nim', nama='$nama', alamat='$alamat', jenis_kelamin='$jenis_kelamin' WHERE nim='$nim'";
